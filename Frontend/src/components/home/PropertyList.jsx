...
// useDispatch gives dispatch funtion to send actions to redux
// useSelector helps to read data from the redux store
...
const PropertyList = () => {
  ...
  // useEffect hook that runs whatever written inside it automatically, like we want to get all the properties as our application starts
  useEffect(() => {
  ...
  }, [currentPage, dispatch]); // (dependency array) whenever the value of dispatch or current page will change this will re run.

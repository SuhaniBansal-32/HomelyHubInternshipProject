// call to backend API's is made through user-action
...
//who is logged in currently, getting current user
...
export const forgotPassword = (email) => async(dispatch) => {
    try{
        ...
        dispatch(userActions.getError(error.response.message));
    }
}

// reset password
// while resetting password the URL contains a token
